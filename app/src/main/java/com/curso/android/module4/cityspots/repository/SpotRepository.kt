...
class SpotRepository(
    ...
    /**
     * usamos cleanup
     * Para que un spot se considere "borrado", el Repository debe:
     * 1. Eliminar el registro en la base de datos (por DAO).
     * 2. Eliminar el archivo físico de la imagen para no dejar basura en el disco.
     *
     * @param spot El spot que se desea eliminar.
     */
    suspend fun deleteSpot(spot: SpotEntity) {
        // 1. Borrado en Base de Datos
        spotDao.deleteSpot(spot)

        // 2. Borrado del archivo físico
        // Usamos cameraUtils porque ya tiene la lógica para manejar URIs de archivos
