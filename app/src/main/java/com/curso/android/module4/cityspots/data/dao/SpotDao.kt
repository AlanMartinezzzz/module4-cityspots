...
interface SpotDao {
    ...
    /**
     * aqui es donde se elmina un spot de la base de datos mencionada
     * * usamos: @Delete
     * Room va a identificar el registro y lo va a elminar por la llave primaria id
     *
     * @param spot El objeto SpotEntity que queremos eliminar
     */
